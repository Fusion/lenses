 ...
 if (!defined('_ADODB_LAYER')) {
	...
	*/
	...
	GLOBAL 
		 ...
		 */
		$ADODB_vers = 'V5.06 29 Sept 2008  (c) 2000-2008 John Lim (jlim#natsoft.com). All rights reserved. Released BSD & LGPL.';
   ...
   * If $sql == false, then we purge all files in the cache.
	...
	*/
	...
	function GetActiveRecordsClass(
			$class, $tableObj,$whereOrderBy=false,$bindarr=false, $primkeyArr=false,
			$extra=array(),
			$relations=array())
	{
